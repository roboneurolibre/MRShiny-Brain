...
ui <- fluidPage(
    ...
    navbarPage("MRShiny Brain",
               ...
               tabPanel("Study Team",
                        ...
                        HTML("<ul>"),
                        HTML("<li> <b> Dr. Jessica Archibald  -</b> Experimental Medicine, University of British Columbia, Vancouver, Canada. </li>"),
                        HTML("<li> <b> Dr. Alexander Mark Weber -</b> Pediatrics, University of British Columbia, Vancouver, Canada. </li>"),
                        HTML("<li> <b> Dr. Paulina Scheuren -</b> Anesthesiology, Pharmacology, and Therapeutics, University of British Columbia, Vancouver, Canada. </li>"),
                        ...
                        HTML("*These two authors contributed equally to this work "),
                        br(), 
